      ...
      <div class="${!0===a?"popup-wrapper":""}">
        <div class="${dt({[o]:!0})}" style="display:flex;width:100%;height:100%;">
          <div id="popup" class="popup-inner" @click="${t=>this._close(t)}">
              ...
              <div id="slider">
                ...
                <div id="slider-center">
                  <div class="values">
                    ...
                    <div class="value">
                      ${this._setTemp?Array.isArray(this._setTemp)?1===r?H`
            ...
            <div id="modes">
              ${(e.attributes.hvac_modes||[]).concat().sort(this._compareClimateHvacModes).map(t=>this._renderIcon(t,o))}
            </div>
